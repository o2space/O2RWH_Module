#
#  Be sure to run `pod spec lint RWHModule.podspec' to ensure this is a
#  valid spec and to remove all comments including this before submitting the spec.
#
#
#  验证是否正确（后面还有一个git的私有地址)
#  pod lib lint RWHModule.podspec --allow-warnings --use-libraries --sources=https://github.com/CocoaPods/Specs.git,https://github.com/wukexiu/O2RWHSpecs.git
#  提交到库  (O2RWHSpecs就是你们的私有库名 后面还有一个git的私有地址)
#  pod repo push O2RWHSpecs RWHModule.podspec --allow-warnings --use-libraries --sources=https://github.com/CocoaPods/Specs.git,https://github.com/wukexiu/O2RWHSpecs.git
...
RWHCore.source_files = 'RWHModuleDemo/BaseModule/RWHCore/**/*.{h,m}'
RWHCore.dependency 'XAspect'
end

s.subspec 'RWHGT' do |RWHGT|
RWHGT.source_files = 'RWHModuleDemo/BaseModule/RWHGT/**/*'
RWHGT.dependency 'RWHModule/RWHCore'
RWHGT.dependency 'XAspect'
RWHGT.dependency 'GTSDK', '~> 1.5.0'
end

s.subspec 'RWHAnalytics' do |RWHAnalytics|
RWHAnalytics.source_files = 'RWHModuleDemo/BaseModule/RWHAnalytics/**/*'
RWHAnalytics.dependency 'RWHModule/RWHCore'
...
#RWHShare.source_files = 'RWHModuleDemo/BaseModule/RWHShare/**/*'
#RWHShare.dependency 'RWHModule/RWHCore'
