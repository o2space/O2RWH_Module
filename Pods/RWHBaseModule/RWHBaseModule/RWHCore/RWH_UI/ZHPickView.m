...
-(UIToolbar *)setToolbarStyle{
    ...
    NSDictionary * attributes = @{NSForegroundColorAttributeName:[UIColor hexStringToColor:@"F73E3E"]};
    [lefttem setTitleTextAttributes:attributes forState:UIControlStateNormal];
    
    UIBarButtonItem *centerSpace=[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:self action:nil];
    
    UIBarButtonItem *right=[[UIBarButtonItem alloc] initWithTitle:@"确定   " style:UIBarButtonItemStylePlain target:self action:@selector(doneClick)];
    [right setTitleTextAttributes:attributes forState:UIControlStateNormal];
...
-(void)remove{
    ...
    NSNotification * noti = [NSNotification notificationWithName:@"LMSPickerViewCancel" object:nil];
